# LK-Mines-2.0-Compatability-Patch
Patches that will add various mod and vanilla resources to Mines 2.0 Bills IF these mods are installed.
Mods Supported:
...
--Cinders of Embergarden

--The Dead Man's Switch

--LK Mineable Resources
